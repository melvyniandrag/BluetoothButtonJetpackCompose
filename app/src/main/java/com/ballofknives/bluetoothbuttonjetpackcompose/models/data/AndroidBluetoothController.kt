...
import com.ballofknives.bluetoothbuttonjetpackcompose.models.domain.BluetoothController
...
const val TAG = "AndroidBluetoothController"
        ...
        return flow {
            ...
            while(shouldLoop) {
                currentClientSocket = try {
                    ...
                    Log.e(TAG, e.message ?: "no error message found")
                    shouldLoop = false
                    null
                }
                emit(ConnectionResult.ConnectionEstablishedByOtherDevice)
    ...
    override fun connectToDevice(device: BluetoothDeviceDomain): Flow<ConnectionResult> {
        return flow {
            ...
            currentClientSocket?.let { socket ->
                try {
                    socket.connect()
                    emit(ConnectionResult.ConnectionEstablishedByMe)
